class ScalesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @scale.save
        format.html { redirect_to new_scale_path, notice: 'Scale was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @scale.update(scale_params)
        format.html { redirect_to new_scale_path, notice: 'Scale was successfully updated.' }
  ...
  def destroy
    @scale.destroy
    respond_to do |format|
      format.html { redirect_to new_scale_path, notice: 'Scale was successfully destroyed.' }
  ...
  private
    ...
    def scale_params
      params.require(:scale).permit(:name, :value)
    end
end
